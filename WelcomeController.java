...
public class WelcomeController {
	...
	public ModelAndView welcome(Map<String, Object> model) {
			ModelAndView mav = new ModelAndView("MyWelcome1");
	...
	public String crete(Map<String, Object> map) {
	...
	public ModelAndView create(@ModelAttribute Person person, BindingResult result, Map<String, Object> map) throws ParseException {
